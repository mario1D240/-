...
local override_p2_color = override_colors and "FF0099" or nil
...
function onCreatePost()
	...
	makeLuaSprite('cuphealthbar', 'zhealthbar/cuphealthbar', 320, 620);
	addLuaSprite('cuphealthbar', false)
	setObjectCamera('cuphealthbar', "hud")	
	setObjectOrder('cuphealthbar', 2)
