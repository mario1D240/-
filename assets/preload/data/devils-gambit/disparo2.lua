...
function onCreate()
    makeAnimatedLuaSprite('GreenShit', 'zassets/cup/images/bull/GreenShitNM', 1900, 1500);
    ...
    makeAnimatedLuaSprite('GreenShit2', 'zassets/cup/images/bull/GreenShitNM', 1900, 1500);
    addAnimationByPrefix('GreenShit2', 'GreenShit', 'GreenShit02 instance 1', 28, false);  
    addLuaSprite('GreenShit2', true);
    setProperty('GreenShit2.visible', false);

    makeAnimatedLuaSprite('GreenShit3', 'zassets/cup/images/bull/GreenShitNM', 1900, 1500);
    addAnimationByPrefix('GreenShit3', 'GreenShit', 'Greenshit03 instance 1', 28, false);  
